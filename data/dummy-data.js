...
export const CATEGORIES = [
  new Category('c8', 'Asian', '#7787AA'),
  new Category('c9', 'French', '#f5d142'),
  new Category('c10', 'Summer', '#f54242'),
  new Category('c3', 'Hamburgers', '#f5a442'),
  new Category('c4', 'German', '#FF9870'),
  new Category('c1', 'Italian', '#ffc7ff'),
  new Category('c5', 'Light & Lovely', '#368dff'),
  new Category('c6', 'Exotic', '#41d95d'),
  new Category('c7', 'Breakfast', '#47fced'),
  new Category('c2', 'Quick & Easy', '#FFAFB5'),
];
